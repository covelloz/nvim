...
keymap('n', '<leader>bqq', ':bd<CR>:bp<CR>', { noremap = true, silent = true, desc = 'close current buffer & go to previous' })
keymap('n', '<leader>bqr', ':BufferLineCloseRight<CR>', { noremap = true, silent = true, desc = 'close all buffers to the right' })
keymap('n', '<leader>bql', ':BufferLineCloseLeft<CR>', { noremap = true, silent = true, desc = 'close all buffers to the left' })
keymap('n', '<leader>bqo', ':BufferLineCloseOthers<CR>', { noremap = true, silent = true, desc = 'close all except current buffer' })
